...
class MyTestCase(unittest.TestCase):
    ...
    def test_get_vaccine_date_ok(self):
        json_files_rf2_path = str(Path.home()) + \
            "/PycharmProjects/G50.2022.T01.EG3/src/JsonFiles/Rf2/"
    ...
    def test_get_vaccine_date_nodosnook(self):
        ...
        json_files_rf2_path = str(Path.home()) + \
            "/PycharmProjects/G50.2022.T01.EG3/src/JsonFiles/Rf2/"
        for p_1,p_2 in param_list_nook:
            with self.subTest(test=p_1):
                file_test = json_files_rf2_path + p_1
                ...
                self.assertEqual(c_m.exception.message, p_2)
    ...
    def test_get_vaccine_date_nook(self):
        ...
        with self.assertRaises(VaccineManagementException) as c_m:
            my_manager.get_vaccine_date(file_test)
        self.assertEqual(c_m.exception.message, "patient_system_id is different")
